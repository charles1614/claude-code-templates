...
npx @charles1614/claude-code-templates --registry=https://npm.pkg.github.com --language javascript-typescript
```
...
git clone https://github.com/charles1614/claude-code-templates.git
...
**Ready to supercharge your JavaScript/TypeScript development?** Run `npx @charles1614/claude-code-templates --registry=https://npm.pkg.github.com --language javascript-typescript` in your project now!